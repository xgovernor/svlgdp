...
import { CircleUser, Info, Layers, Bell, Menu, Search } from "lucide-react";
...
const Header = () => {
    return (
        <header>
            <nav className="flex items-center justify-between lg:grid lg:grid-cols-12 py-1 px-4 bg-[#1B1B1F] text-white border-b border-b-[#343434]">
                ...
                <div className="hidden lg:flex justify-center items-center gap-4 lg:col-start-5 lg:col-end-9">
                    <div className="w-full flex items-center bg-black border border-[#343434] rounded-sm ring-0 outline-none shadow-none overflow-hidden">
